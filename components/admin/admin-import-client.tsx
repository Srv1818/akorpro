...
// Canonical: keyMode + gamlarScaleId birlikte gönderin (önerilen)
// keyMode: major | natural | harmonic | melodic
// gamlarScaleId: keyMode ailesiyle uyumlu katalog id (ör. major->maj-ionian, natural->nm-aeolian)
