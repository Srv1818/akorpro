  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-12">
      <div className="overflow-hidden rounded-2xl border border-border bg-surface shadow-sm">
        <div className="h-28 bg-accent/20" />
          ...
          <div className="grid gap-4">
            <div className="flex items-center gap-4 rounded-xl border border-border/50 bg-bg p-4 transition hover:bg-bg/80">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate font-medium text-foreground" title={email}>
                  {email}
                </p>
              </div>
            </div>
            ...
            <Link
              href="/iletisim"
              className="flex items-center gap-4 rounded-xl border border-border/50 bg-bg p-4 transition hover:bg-bg/80"
            >
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-surface">
                <MessageCircle className="h-5 w-5 text-muted" />
              </div>
              <div className="min-w-0 flex-1">
                <p className="text-sm font-medium text-muted">İletişim paneli</p>
                <p className="font-medium text-accent">Soru ve geri bildirim için tıklayın</p>
              </div>
            </Link>
          </div>
        </div>
