...
function buildCsp(): string {
  ...
  const directives: string[] = [
    ...
    `img-src 'self' data: blob: https://*.googleusercontent.com https://www.google-analytics.com https://firebasestorage.googleapis.com https://res.cloudinary.com${storageBucket ? ` https://${storageBucket}` : ""}`,
    ...
    `frame-src 'self' https://apis.google.com https://www.youtube.com https://www.youtube-nocookie.com https://player.vimeo.com${authDomain ? ` https://${authDomain}` : ""}`,
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
